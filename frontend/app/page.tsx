...
export default function Home() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const data = await analyze({ url: url.trim(), adCsv, returnsCsv }, controller.signal);
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-zinc-800/60 bg-zinc-950/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-base font-semibold tracking-tight">doThis</span>
          </div>
      ...
      <section id="analiz" className="relative overflow-hidden pt-24">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 pb-16 pt-16 text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/8 px-4 py-1.5">
            ...
            <span className="text-xs font-medium text-violet-300">AI destekli kâr analizi · Ücretsiz</span>
          </div>

          <h1 className="font-display text-5xl font-semibold leading-[1.1] tracking-tight text-zinc-50 sm:text-6xl">
            E-ticaret kârını yiyen
            <br />
          ...
          <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-zinc-400">
            Ürün görünürlüğü, reklam israfı ve iade korelasyonunu tek analizde
            birleştiren yapay zeka platformu. Rakiplerinizden önce harekete geçin.
          </p>
          ...
          <div className="mt-10 rounded-2xl border border-zinc-800 bg-zinc-900/80 p-6 shadow-2xl shadow-black/50 backdrop-blur-sm">
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="mt-1 flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-4 py-3.5 text-sm font-semibold text-white transition-all hover:bg-violet-500 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-3 flex flex-wrap justify-center gap-2">
              {["Trendyol", "Hepsiburada", "Amazon"].map((p) => (
      ...
      <section className="border-y border-zinc-800/60 bg-zinc-900/30">
        <div className="mx-auto max-w-5xl px-6 py-8">
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
            {[
              { label: "GEO Görünürlüğü", sub: "Yapay zeka aramalarında skor", icon: "🔍" },
              { label: "Reklam ROI Haritası", sub: "Kelime bazında verimlilik", icon: "📊" },
              { label: "İade Korelasyonu", sub: "Kök sebep tespiti", icon: "↩" },
              { label: "Birleşik Analiz", sub: "Tüm sorunların kesişimi", icon: "✦" },
            ].map((s) => (
      ...
      <section id="nasil-calisir" className="mx-auto max-w-5xl px-6 py-24">
        <div className="mb-14 text-center">
          ...
          <h2 className="font-display text-3xl font-semibold text-zinc-100">3 adımda kâr analizi</h2>
          <p className="mx-auto mt-3 max-w-md text-sm text-zinc-500">
            Kurulum yok, API anahtarı yok. URL yapıştır, sonuçları al.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-lg">
          <Step
            ...
            description="Trendyol, Hepsiburada veya Amazon'dan herhangi bir ürün sayfası linkini gir. Sistem otomatik olarak ürün verilerini tarar."
          />
          <Step
            number="2"
            title="Reklam ve iade verilerini yükle"
            description="Google Ads, Meta Ads veya Trendyol reklam CSV'sini ekle. İade raporunu da yükleyebilirsin. Her ikisi de isteğe bağlıdır."
          />
          <Step
            number="3"
            title="Önceliklendirilmiş aksiyonları al"
            last
            description="AI, GEO skoru · reklam israfı · iade korelasyonunu birleştirip kopyalanıp uygulanabilir bir kâr kurtarma planı sunar."
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-6 py-24">
          <div className="mb-14 text-center">
            ...
            <h2 className="font-display text-3xl font-semibold text-zinc-100">
              Dört boyutlu kâr haritası
            </h2>
            <p className="mx-auto mt-3 max-w-md text-sm text-zinc-500">
              Her analiz tek başına değerlidir. Ama birlikte, hiçbir aracın göremediği bağlantıları kurar.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <FeatureCard
              ...
              description="ChatGPT ve Gemini'de neden görünmüyorsunuz. 4 kritere göre 0–100 puan. Eksik anahtar kelimeler ve rakip analizi."
            />
            <FeatureCard
              ...
              description="Her anahtar kelimenin verimliliği, CTR kalitesi, dönüşüm hunisindekie kayıp noktaları ve CPA analizi."
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              description="Tüm sorunların birbirini nasıl beslediği. Düşük GEO → yanlış kitle → yüksek iade zincirinin tam haritası."
            />
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-12 sm:grid-cols-2 sm:items-center">
          <div>
            ...
            <h2 className="font-display text-3xl font-semibold leading-snug text-zinc-100">
              Satıcıların gördüğü veriyi,
              <br />
              uzman gibi yorumla.
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-zinc-500">
              doThis, Türkiye e-ticaret pazarındaki satıcıların kâr kaynaklarını
              tespit etmek için geliştirilen yapay zeka destekli bir analiz platformudur.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-zinc-500">
              GEO optimizasyonu (yapay zeka arama görünürlüğü), reklam israfı analizi
              ve iade korelasyonunu tek çatı altında birleştirerek, şimdiye kadar tek
              başına hiçbir araçla elde edilemeyen içgörüler sunar.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-zinc-500">
              Tamamen stateless ve ücretsiz çalışır. Verileriniz hiçbir yerde saklanmaz.
            </p>
          </div>

          <div className="flex flex-col gap-4">
            {[
              { label: "Stateless mimari", desc: "Verileriniz hiçbir yerde saklanmaz, her analiz sıfırdan başlar." },
              { label: "Gemini 2.0 Flash ile", desc: "Google'ın en hızlı AI modeli — derin analiz, anlık sonuç." },
              { label: "Türkçe e-ticaret odaklı", desc: "Trendyol, Hepsiburada ve yerel reklam formatları için optimize edilmiştir." },
            ].map((v) => (
      ...
      <section className="border-y border-zinc-800/60 bg-zinc-900/30">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center">
          <h2 className="font-display text-3xl font-semibold text-zinc-100">
            Kâr sızıntısını şimdi bul.
          </h2>
          <p className="mx-auto mt-3 max-w-md text-sm text-zinc-500">
            Üye olmaya, kart vermeye veya kurulum yapmaya gerek yok. Sadece URL.
          </p>
          <button
            type="button"
            onClick={() => document.querySelector("#analiz")?.scrollIntoView({ behavior: "smooth" })}
      ...
      <footer className="border-t border-zinc-800/60">
        <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-4 px-6 py-8 sm:flex-row">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-zinc-300">doThis</span>
            <span className="text-sm text-zinc-600">· E-ticaret Kâr Analizi</span>
          </div>
          <div className="flex items-center gap-6">
            <NavLink href="#nasil-calisir">Nasıl Çalışır</NavLink>
            <NavLink href="#hakkimizda">Hakkımızda</NavLink>
